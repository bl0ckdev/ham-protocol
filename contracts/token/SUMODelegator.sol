...
import "./SUMODelegate.sol";

contract SUMODelegator is SUMOTokenInterface, SUMODelegatorInterface {
    /**
     * @notice Construct a new SUMO
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "SUMODelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"SUMODelegator:fallback: cannot send value to fallback");
