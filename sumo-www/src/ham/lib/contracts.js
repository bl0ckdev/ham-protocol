...
import SUMOJson from '../clean_build/contracts/SUMODelegator.json';
import SUMORebaserJson from '../clean_build/contracts/SUMORebaser.json';
import SUMOReservesJson from '../clean_build/contracts/SUMOReserves.json';
import SUMOGovJson from '../clean_build/contracts/GovernorAlpha.json';
import SUMOTimelockJson from '../clean_build/contracts/Timelock.json';
...
import WETHPoolJson from '../clean_build/contracts/SUMOETHPool.json';
import AMPLPoolJson from '../clean_build/contracts/SUMOAMPLPool.json';
import YFIPoolJson from '../clean_build/contracts/SUMOYFIPool.json';

import MKRPoolJson from '../clean_build/contracts/SUMOMKRPool.json';
import LENDPoolJson from '../clean_build/contracts/SUMOLENDPool.json';
import COMPPoolJson from '../clean_build/contracts/SUMOCOMPPool.json';
import SNXPoolJson from '../clean_build/contracts/SUMOSNXPool.json';
import LINKPoolJson from '../clean_build/contracts/SUMOLINKPool.json';

import IncJson from '../clean_build/contracts/SUMOIncentivizer.json';
...
export class Contracts {
  constructor(
    ...
    this.sumo = new this.web3.eth.Contract(SUMOJson.abi);
    ...
    this.sumo_ycrv_uni_lp = new this.web3.eth.Contract(ERC20Json.abi);
    ...
    this.rebaser = new this.web3.eth.Contract(SUMORebaserJson.abi);
    this.reserves = new this.web3.eth.Contract(SUMOReservesJson.abi);
    this.gov = new this.web3.eth.Contract(SUMOGovJson.abi);
    this.timelock = new this.web3.eth.Contract(SUMOTimelockJson.abi);
  ...
  setProvider(
    ...
    this.sumo.setProvider(provider);
    ...
    const contracts = [
      { contract: this.sumo, json: SUMOJson },
      { contract: this.rebaser, json: SUMORebaserJson },
      { contract: this.reserves, json: SUMOReservesJson },
      { contract: this.gov, json: SUMOGovJson },
      { contract: this.timelock, json: SUMOTimelockJson },
    ...
    this.sumo_ycrv_uni_lp.options.address = addressMap["SUMOYCRV"];
  ...
  setDefaultAccount(
    ...
    this.sumo.options.from = account;
