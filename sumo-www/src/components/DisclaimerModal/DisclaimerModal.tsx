...
const DisclaimerModal: React.FC<DisclaimerModal> = ({ onConfirm, onDismiss }) => {
  ...
  const modalContent = useMemo(() => {
    if (step === 'disclaimer') {
      ...
      return (
        <div>
          <p>Attention SUMO Uniswap LPs</p>
          <p>The only Uniswap pool that is compatible with SUMO is SUMO/yCRV (Curve yPool tokens)</p>
